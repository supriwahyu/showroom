                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{$car->model}}</td>
                                                <td>
                                            <form method="POST" action="{{url('testdrivelist/delete/' .$car->id)}}">
                                            @csrf
                                            <input type="hidden" name="_method" value="DELETE" />
                                            <div class="btn-group">
                                                <a class="btn btn-info" href="{{url('testdrivelist/' .$car->id)}}"><i class="fa fa-eye"></i></a>
                                                <a class="btn btn-success" href="{{url('testdrivelist/edit/' .$car->id)}}" title="Ubah Data Perusahaan"><i class="fa fa-magic" aria-hidden="true"></i></a>
